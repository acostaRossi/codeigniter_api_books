...
<body>
	...
	<div class="w3-top">
	  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
	    ...
	    <a href="<?= base_url() ?>/books" class="w3-bar-item w3-button w3-padding-large w3-white">Books</a>
	    <a href="<?= base_url() ?>/books/new" class="w3-bar-item w3-button w3-padding-large">Create</a>
	  </div>
	</div>
